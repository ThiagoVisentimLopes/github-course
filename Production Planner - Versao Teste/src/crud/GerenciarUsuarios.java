...
public class GerenciarUsuarios extends javax.swing.JFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
         if (evt.getClickCount() == 2) {
            ...
            jComboBox1.setSelectedItem(modelo.getValueAt(i, 3).toString());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String permicao =jComboBox1.getSelectedItem().toString();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            if (JOptionPane.showConfirmDialog(this, "Você tem certeza?", "CONFIRMAÇÃO", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
                ...
                statement.executeUpdate("DELETE FROM usuario WHERE id_usuario =" + id);
                limparCampos();
                reiniciarBotoes();
                popularTabela();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            statement.executeUpdate("UPDATE usuario SET nome='" + nome
                + "',senha='" + senha
                + "',permicao='" + permicao
                + "',setor='" + setor
